...
$viewquery="SELECT st.regno,e.blockname,e.floor,e.hallname,s.seat,s.semister,s.date FROM addstudents st,addexamhall e,addseat s where st.regno=s.regno and st.branch=e.branch and s.branch=st.branch  and st.sem=e.sem and st.sem=s.semister order by st.regno ";
